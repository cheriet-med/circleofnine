...
export function GlobeDemo() {
 ...
 <>
    ...
    <div className="flex  flex-col items-center justify-center pt-40  lg:h-[1600px] h-auto dark:bg-black bg-[#000035] relative w-full">
   ...
   <HomeBottomText/>
      <div className="w-full h-[520px] md:h-[650px] lg:h-[1200px]"> {/* Increased globe container height */}
