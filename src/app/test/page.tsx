...
export default function CompareDemo() {
  ...
  return (
    <div className="mx-auto bg-[#4c0000] py-48">
    ...
    <div className="w-full max-w-8xl mx-auto h-[90vh] px-1 md:px-8 flex items-center justify-center [perspective:800px] [transform-style:preserve-3d]">
      <div
        style={{
